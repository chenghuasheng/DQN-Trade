...
class BaseNet(object):
    ...
    def replace_to(self, target_net, source_vars=None, target_vars=None, soft_update=True):
    ...
    def _trainer(self, loss, learning_rate, var_list=None):
        optimizer = tf.train.AdamOptimizer(learning_rate)
        train_op = optimizer.minimize(loss, global_step=self.train_step, var_list=var_list)
        return train_op
    ...
    def fill_feed_dict(self, packaged_data, keep_prob=1.0):
        feed_dict = {
            ...
            self.input_index_min5: packaged_data.index_min5,
